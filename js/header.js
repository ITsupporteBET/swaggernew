            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="osm.html" onclick="window.location.reload();">OSM</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <!-- <a class="dropdown-item" href="faq.html" onclick="window.location.reload();">FAQ</a> -->
                        ...
                        <a class="dropdown-item" href="client_error.html" onclick="window.location.reload();">Client error code</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
